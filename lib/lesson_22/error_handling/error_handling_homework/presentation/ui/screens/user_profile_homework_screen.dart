      ...
      body: BlocBuilder<UserProfileCubit, UserProfileState>(
        builder: (context, state) {
          return switch (state) {
            ...
            UserProfileServerError() => _ErrorProfileWidget(state.message),

            UserProfileUnknownError() => _ErrorProfileWidget(state.message),
          };
        },
      ),
    );
...
class _ErrorProfileWidget extends StatelessWidget {
  const _ErrorProfileWidget(this.errorMessage);
